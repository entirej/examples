 ...
 * to <code>PAYMENT_TERMS</code> table
 */
public class PaymentTermsService
{
    ...
    /**
     * Checks to see if there is already an entry in the "PAYMENT_INFORMATION"
     * table with the given salutation
     * 
     * @param term
     *            The payment term to check for
     * @param id
     *            The id to check for
     * @return <code>true</code> if there is already a term value in
     *         "PAYMENT_INFORMATION" table with this payment term, otherwise
     *         <code>false</code>
     */
