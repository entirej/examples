...
public class InvoiceService
{
    ...
    /**
     * Checks to see if there is already an entry in the "INVOICE" table with
     * the given invoice number
     * 
     * @param nr
     *            The invoice number to check for
     * @return <code>true</code> if there is already a invoice number in
     *         "INVOICE" table with this number, otherwise <code>false</code>
     */
