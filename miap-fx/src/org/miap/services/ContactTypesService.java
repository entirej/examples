 ...
 * to <code>CONTACT_TYPES</code> table
 */
public class ContactTypesService
{
    ...
    /**
     * Checks to see if there is already an entry in the "CONTACT_TYPES" table
     * with the given type
     * 
     * @param name
     ...
     * @param id
     *            The id to check for
     * @return <code>true</code> if there is already a type value in
     *         "CONTACT_TYPES" table with this type, otherwise
     *         <code>false</code>
     */
     ...
     * ContactTypesService.MAIN else it will create a new record with
     * ContactTypesService.MAIN type and re-query
     * 
     * @param con
    ...
    /**
     * Creates a new contact type with the type ContactTypesService.MAIN in the
     * database
     * 
     * @param con
     *            An EJ database connection
