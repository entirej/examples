...
public class VATRatesService
{
    ...
    /**
     * Checks to see if there is already an entry in the "VAT_RATES" table with
     * the given name
     * 
     * @param name
     ...
     * @param id
     *            The id to check for
     * @return <code>true</code> if there is already a vat name value in
     *         "VAT_RATES" table with this vat name, otherwise
     *         <code>false</code>
     */
