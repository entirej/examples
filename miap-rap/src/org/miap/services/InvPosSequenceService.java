...
/**
 * This class is used to query and select the next value from a database sequence for invoice
 * position.
 */
public class InvPosSequenceService
{
    ...
    /**
     * Perform a DB query to "INV_POS_SEQUENCE" sequence and select and return the next
     * <code>java.lang.Integer</code> value
     * 
     * @param connection
     * 
     * @return next </code>java.lang.Integer</code> value from "INV_POS_SEQUENCE" H2 sequence
     */
