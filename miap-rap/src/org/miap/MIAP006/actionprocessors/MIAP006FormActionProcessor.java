...
public class MIAP006FormActionProcessor extends MIAPDefaultFormActionProcessor implements EJFormActionProcessor
{
    ...
    public void executeActionCommand(EJForm form, EJRecord record, String command, EJScreenType screenType) throws EJActionProcessorException
    {
        if (record.getBlockName() != null
                && ((record.getBlockName().equals(F_MIAP006.B_SALUTATIONS_BLOCK.ID)) || record.getBlockName().equals(F_MIAP006.B_SALUTATIONS_TOOLBAR.ID)))
        {
            ...
            if (F_MIAP006.AC_TOOLBAR_DELETE.equals(command) && form.getBlock(F_MIAP006.B_SALUTATIONS_BLOCK.ID).getFocusedRecord() != null)
            {
                ...
                form.getBlock(F_MIAP006.B_SALUTATIONS_BLOCK.ID).askToDeleteCurrentRecord("Are you sure you want to delete this salutation?");
                return;
            }
