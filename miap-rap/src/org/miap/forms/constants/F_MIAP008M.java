 ...
 */
public class F_MIAP008M
{
    public static final String ID = "MIAP008M";
    ...
    public static class B_CONTACT_TYPES_BLOCK
    {
        public static final String ID            = "ContactTypesBlock";
    ...
    public static final String C_CONTACT_TYPES_TAB = "ContactTypesTab";

    public static class C_CONTACT_TYPES_TAB_PAGES
    {
        public static final String CONTACT_TYPES_PAGE = "ContactTypesPage";

    }

    public static final String C_CONTACT_TYPES_BLOCK   = "ContactTypesBlock";
