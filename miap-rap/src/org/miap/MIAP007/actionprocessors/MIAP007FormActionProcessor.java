...
public class MIAP007FormActionProcessor extends MIAPDefaultFormActionProcessor implements EJFormActionProcessor
{
    ...
    public void executeActionCommand(EJForm form, EJRecord record, String command, EJScreenType screenType) throws EJActionProcessorException
    {
        if (record.getBlockName() != null
                && ((record.getBlockName().equals(F_MIAP007.B_VAT_RATES_BLOCK.ID)) || record.getBlockName().equals(F_MIAP007.B_VAT_RATES_TOOLBAR.ID)))
        {
            ...
            if (F_MIAP007.AC_TOOLBAR_DELETE.equals(command) && form.getBlock(F_MIAP007.B_VAT_RATES_BLOCK.ID).getFocusedRecord() != null)
            {
                ...
                form.getBlock(F_MIAP007.B_VAT_RATES_BLOCK.ID).askToDeleteCurrentRecord("Are you sure you want to delete this rate?");
                return;
            }
